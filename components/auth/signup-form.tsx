...
export default function SignupForm(setState: SigninFormProps) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-900 p-4">
      <div className="shadow-lg mx-auto w-full max-w-md rounded-xl bg-white dark:bg-neutral-800 p-6 md:p-8 border border-neutral-200 dark:border-neutral-700">
        ...
        <form className="my-8" onSubmit={handleSubmit}>
          ...
          <button
            className="group/btn relative block h-10 w-full rounded-lg bg-gradient-to-br from-blue-600 cursor-pointer to-blue-500 font-medium text-white shadow-md hover:shadow-lg transition-all"
            type="submit"
          >
            Sign Up &rarr;
            <BottomGradient />
          ...
          <div className="flex flex-col space-y-3">
            <button
              className="flex items-center justify-center h-10 w-full rounded-lg border border-neutral-300 dark:border-neutral-600 bg-white cursor-pointer dark:bg-neutral-700 px-4 font-medium text-neutral-700 dark:text-neutral-200 hover:bg-neutral-50 dark:hover:bg-neutral-600 transition-colors"
              type="button"
            >
          ...
          onClick={() => setState.setState("signIn")}
           className="mt-6 text-center text-sm text-neutral-600 dark:text-neutral-400 cursor-pointer">
